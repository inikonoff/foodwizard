...
async def cmd_start(message: Message):
    ...
    # Если это Callback (нажали Restart), то редактируем, если Message - отправляем
...
# !!! НОВАЯ ФУНКЦИЯ ДЛЯ КНОПКИ RESTART !!!
