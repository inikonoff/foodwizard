...
# ... (handle_text_message и handle_category_selection ОСТАЮТСЯ БЕЗ ИЗМЕНЕНИЙ) ...
# Я привожу только handle_text_message и handle_category_selection для полноты файла,
# если вы будете копировать целиком.
...
# --- ОБНОВЛЕННАЯ ФУНКЦИЯ ДЛЯ ГЕНЕРАЦИИ РЕЦЕПТА ---
async def handle_dish_selection(callback: CallbackQuery):
    ...
    try:
        ...
        # ПРОВЕРЯЕМ СТАТУС И СТАВИМ НУЖНУЮ КНОПКУ
